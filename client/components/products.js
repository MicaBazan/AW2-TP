    ...
    return `
        <div class="max-w-xs overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
            ...
            <div class="flex items-center justify-between px-4 py-2 bg-orange-300">
                ...
                <button class="px-2 py-1 text-xs font-semibold text-gray-900 uppercase transition-colors duration-300 transform bg-white rounded hover:bg-gray-200 focus:bg-gray-400 focus:outline-none" id="cargar-carrito">Agregar al carro</button>
            </div>
        </div>
