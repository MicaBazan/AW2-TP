export const products = ( nombre, descripcion, image, precio)=>{
    return `
        <div class="max-w-xs overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
            <div class="px-4 py-2">
                <h1 class="text-xl font-bold text-gray-800 uppercase dark:text-white" name="nombre-producto">${nombre}</h1>
            ...
            <div class="flex items-center justify-between px-4 py-2 bg-orange-300">
                ...
                <button class="px-2 py-1 text-xs font-semibold text-gray-900 uppercase transition-colors duration-300 transform bg-white rounded hover:bg-gray-200 focus:bg-gray-400 focus:outline-none" name="cargar-carrito">Agregar al carro</button>
            </div>
        </div>
